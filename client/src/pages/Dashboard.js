...
const Dashboard = () => {
  ...
  const [itemToFavorite, setItemToFavorite] = useState(null); // { type: 'movie' | 'track', data: ... }
        ...
        if (itemToFavorite.type === 'track') {
            await axios.post('http://localhost:5000/api/users/favorites/add', {
                ...
                track: {
                    ...
                    artistId: itemToFavorite.data.artistId, // Detaydan geliyorsa vardır
        ...
        {result && !loading && (
          <div className="grid md:grid-cols-2 gap-8 text-left animate-fade-in-up">
            ...
            <div 
                ...
                className="bg-gray-800 rounded-2xl overflow-hidden shadow-2xl border border-gray-700 hover:border-green-500 transition duration-300 cursor-pointer group relative"
            >
              ...
              <div className="p-6">
                ...
                <button 
                    ...
                    className="w-full bg-green-600 hover:bg-green-500 text-white py-3 rounded-xl font-bold shadow-lg transition flex items-center justify-center gap-2 mb-2"
                >
                    ▶ Listen Now
                </button>
              </div>
            ...
            <div 
                ...
                className="bg-gray-800 rounded-2xl overflow-hidden shadow-2xl border border-gray-700 hover:border-yellow-500 transition duration-300 cursor-pointer group relative"
            >
              <div className="relative h-64">
                    ...
                    <>
                        ...
                        <div className="w-full md:w-2/3 p-8 flex flex-col">
                            ...
                            <div className="mt-auto pt-4 border-t border-gray-700">
                                <button onClick={() => initiateFavorite('movie', selectedMovie)} className="w-full bg-yellow-600 hover:bg-yellow-500 text-black py-3 rounded-lg font-bold transition shadow-lg">❤️ Add to Favorites</button>
                            </div>
                        </div>
                    </>
                )}
