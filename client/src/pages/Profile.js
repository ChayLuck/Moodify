...
const Profile = () => {
  ...
  if (loading)
    return <div className="text-white text-center mt-20 text-xl">Loading Profile...</div>;
      ...
      {toast.open && (
        <div className="fixed top-48 left-1/2 -translate-x-1/2 z-[9999] animate-slide-down">
          ...
          `}>
            ...
            <button onClick={() => setToast(prev => ({ ...prev, open: false }))} className="text-gray-400 hover:text-gray-200 text-lg leading-none ml-2">×</button>
          </div>
        </div>
      )}
          ...
          >
            ...
            <div className="w-full md:w-1/2 p-8 flex flex-col">
              ...
              <div className="space-y-3 text-gray-300 text-sm mb-8">
                ...
                <div className="flex justify-between border-b border-gray-800 pb-2">
                  <span>Released</span> <span className="text-white">{selectedTrack.releaseDate}</span>
                </div>
              ...
              <div className="flex gap-4 mt-auto">
                <button onClick={() => setPlayingTrack(selectedTrack._id)} className="flex-1 bg-green-600 hover:bg-green-500 text-white py-3 rounded-lg font-bold shadow-lg">
                  ▶ Play Now
                </button>
                <button
                  onClick={() => handleRemoveFavorite(selectedTrack._id, selectedTrack.title)}
        ...
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-[80] animate-fade-in">
          <div className="bg-gray-800 p-8 rounded-2xl max-w-md w-full border border-gray-600 shadow-2xl text-center">
            ...
            <p className="text-gray-400 mb-6 text-sm">
              Are you sure you want to remove <span className="text-green-400 font-semibold">{removeConfirm.trackName}</span> from your favorites?
            </p>
